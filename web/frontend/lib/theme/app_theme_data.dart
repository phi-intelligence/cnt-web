...
class AppThemeData {
  ...
  static ThemeData lightTheme = ThemeData(
    ...
    cardTheme: CardThemeData(
      ...
      shape: RoundedRectangleBorder(
        borderRadius:
            BorderRadius.circular(24), // Increased from medium (16) to 24
    ...
    // Popup menu theme - ensure white background
  ...
  // Dark theme removed - application uses light theme only
  // static ThemeData darkTheme = ThemeData(...) - DISABLED
}
